...
function VerificationPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-slate-50 dark:bg-black text-slate-900 dark:text-slate-100 relative selection:bg-orange-500/30 selection:text-white transition-colors duration-300">
