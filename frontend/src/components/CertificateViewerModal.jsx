      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/90 backdrop-blur-xl overflow-y-auto print:p-0 print:bg-transparent">
        ...
        >
          ...
          <div
            ...
            className="certificate-print-area relative w-full aspect-[1.414/1] bg-white text-slate-900 p-6 sm:p-10 md:p-12 rounded-xl border border-slate-300 shadow-2xl flex flex-col justify-between overflow-hidden select-none"
          >
            ...
            <div className="flex items-start justify-between border-b border-slate-200 pb-3 z-10">
              <div className="flex items-center gap-3">
                <img src="/favicon.png" alt="OpportunityX" className="w-10 h-10 sm:w-12 sm:h-12 object-contain" />
                <div>
            ...
            <div className="text-center my-auto py-2 z-10 space-y-3">
              ...
              <div className="inline-block">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 tracking-tight pb-1 px-8">
                  {recipient}
                </h2>
                <div className="h-0.5 w-full bg-slate-900 mx-auto" />
              </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-12 pt-3 pb-1">
                ...
                <div className="flex items-center gap-2.5 text-left">
                  <Clock size={24} className="text-slate-800 shrink-0 stroke-[1.5]" />
                  <div>
                    ...
                    <span className="text-[9px] font-mono text-slate-500 block">(Jan 2026 - Jun 2026)</span>
                  </div>
                </div>
                ...
                {/* Issued Date */}
                <div className="flex items-center gap-2.5 text-left">
                  <Calendar size={24} className="text-slate-800 shrink-0 stroke-[1.5]" />
                  <div>
                ...
                {/* Issued By */}
                <div className="flex items-center gap-2.5 text-left">
                  <Building2 size={24} className="text-slate-800 shrink-0 stroke-[1.5]" />
                  <div>
            ...
            <div className="flex items-center justify-between border-t border-slate-200 pt-3 z-10">
              ...
              <div className="flex items-center gap-2.5 bg-slate-50 p-2 rounded-lg border border-slate-200">
                <div className="p-1 bg-white rounded border border-slate-300 shrink-0">
                  <QRCodeSVG value={url} size={52} level="M" fgColor="#0F172A" />
                </div>
                <div className="text-left space-y-0.5 font-mono">
                  ...
                  <span className="text-[10px] text-slate-900 font-black block">
                    {certificate_id}
                  </span>
              ...
              <div className="text-center space-y-1">
                <div className="w-11 h-11 mx-auto rounded-full border-2 border-amber-500 bg-white p-0.5 shadow-sm flex items-center justify-center">
              ...
              {/* Authority Signature Image (Using Ultra-Crisp Transparent Dark Ink Signature) */}
              <div className="text-right space-y-0.5">
                ...
                <p className="text-[10px] font-bold text-slate-900">Digitally Signed</p>
                <p className="text-[9px] text-slate-600 font-medium">OpportunityX Verification Registry</p>
                <p className="text-[8px] font-mono text-slate-500 truncate max-w-[170px]">
